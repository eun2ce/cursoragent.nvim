--- Working directory resolution helpers for CursorAgent.nvim
---@module 'cursoragent.cwd'
...
---@param term_cfg CursorAgentTerminalConfig
---@param ctx CursorAgentCwdContext
---@return string|nil
