---@mod cursoragent.git Git integration for cursoragent.nvim
---@brief [[
--- This module provides git integration functionality for cursoragent.nvim.
...
function M.get_git_root()
  ...
  if vim.env.CURSOR_AGENT_TEST_MODE == 'true' then
