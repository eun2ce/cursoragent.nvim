...
local function handler(params)
  local log_module_ok, log = pcall(require, "cursoragent.logger")
  ...
  -- Tab name format: "✻ [Cursor Agent] README.md (e18e1e) ⧉"
  ...
  if tab_name:match("✻") and tab_name:match("⧉") then
    ...
    local diff_module_ok, diff = pcall(require, "cursoragent.diff")
